...
/**
 * [Appendix] application must inherit from Application class
...
public:
	...
	/**
	 * [Appendix] application must have a factory method that creates an instance of itself.
	 */
...
protected:
	AppController 	* 	 	__pAppController;
